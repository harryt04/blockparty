...
| Create form | Heading, grouped fields, piece picker, Human/Computer steppers, collapsed rules summary, seat tray, one submit | One column; seat tray wraps without becoming a second page |
