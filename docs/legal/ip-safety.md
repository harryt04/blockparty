# IP Safety for an Original Property Board Game
...
The U.S. Copyright Office explains that copyright does not protect the idea for a game, its name or title, or the method of play; it can protect original expressive material such as text, artwork, and other authorship embodied in the game. Read the Office's primary guidance: [Copyright Registration for Games](https://www.copyright.gov/register/tx-games.html). Applying that distinction to a complete rules combination or product requires legal advice.

Trademark law focuses on source identification and likelihood of consumer confusion, not merely exact word matching. Start searches at [USPTO Trademark Search](https://www.uspto.gov/trademarks/search) and review the USPTO’s [likelihood-of-confusion guidance](https://www.uspto.gov/trademarks/search/likelihood-confusion). Similar names, logos, trade dress, related goods/services, market channels, and consumer context can matter.

These are United States starting points only. A globally reachable launch also requires counsel-owned analysis of launch territories, unfair competition, passing off, trade dress, patents, design rights, contractual restrictions, and other applicable regimes. Do not infer worldwide safety from U.S. registration guidance.
...
Before using a name, logo, or slogan, assess whether people could mistakenly believe the project is made by, sponsored by, affiliated with, or endorsed by another source. Exact identity is unnecessary for risk. Run the workflow in [Naming](../brand/naming.md), then have counsel review the evidence.

### Blockparty-specific controls

**Blockparty** is the provisional mark adopted on 2026-09-02. It is **not cleared**. **Civora** is the designated fallback and must stay viable. The decision record and known collisions are in [Naming](../brand/naming.md).

This mark carries higher-than-usual risk for three reasons. Treat each as a standing control, not a one-time check.
...
Because the mark is provisional, no design or content decision may depend on it. If a choice only works when the name is Blockparty, it is a defect.
...
Keep references to external games or brands only in private, access-controlled research and legal-review materials where necessary. Do not use them in public product names, metadata, app listings, package descriptions, keywords, SEO, social posts, trailers, press kits, screenshots, onboarding, or comparisons. Any nominative reference, if counsel says one is needed, must be factual, minimal, non-prominent, and never imply affiliation; obtain written legal approval first.
...
- Inventory every code dependency, font, icon set, sound library, image, model, and build artifact.
- Record version, source URL, license text/version, attribution/notice requirements, modification conditions, and compatibility with the project’s distribution model.
- Verify that font licensing explicitly permits web embedding, self-hosting, subsetting, and commercial use if applicable; do not assume a downloadable font is web-licensed.
- Respect copyleft, source-offer, attribution, patent, and trademark clauses. Ask counsel/maintainers when a license is unclear.
- Keep required notices in the repository and shipped product. Do not strip credits from assets or dependencies.
...
No public alpha, production launch, app-store submission, package publication, crowdfunding, merchandise, paid sponsorship, or public marketing campaign may proceed until a designated project owner records written approval from qualified counsel (or a documented counsel-approved exception). The release packet must include:

1. Approved product name, logo, slogans, and jurisdictions, plus the search/clearance record from [Naming](../brand/naming.md).
2. Current board screenshots/video and a source-confusion/trade-dress review against the principles in [Brand Strategy](../brand/brand-strategy.md).
3. Complete asset provenance register, license inventory, notices, and contributor-rights status.
4. Final public copy, store metadata, SEO terms, press kit, and social launch material confirming no affiliation implication or prohibited comparison.
5. Code/content/trademark license documents and a plan for required attribution.
6. Open issues, risk acceptances, counsel advice, approver, date, and scope of release.

Material changes after approval—especially the name, logo, board presentation, public comparisons, assets, distribution territory, or monetization—trigger a renewed review. Preserve a dated release record.

## Day-to-day escalation

- **Before merge:** contributor and reviewer verify provenance and originality.
- **Before design lock:** brand owner runs the source-confusion review and checks [Brand Strategy](../brand/brand-strategy.md).
- **Before public naming:** follow [Naming](../brand/naming.md) and obtain the release gate approval.
- **On a complaint or uncertainty:** do not debate publicly, concede liability, delete evidence, or make legal promises. Restrict further use where feasible, preserve records, and escalate to the project owner and counsel.
